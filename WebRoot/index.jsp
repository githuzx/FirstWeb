		...
		<li>HTML/CSS:
			<ol>
				...
				<li><a href="page/htmlcss_layout.jsp" target="_blank"
					title="如何用CSS进行网页布局">layout.jsp</a></li>
			</ol></li>
		...
		<li>JavaScript:
			<ol>
				...
				<li><a href="page/javascript_profoundsimp.jsp" target="_blank"
					title="JavaScript深入浅出">profoundsimp.jsp</a>
				</li>
			</ol></li>
		...
		<li>WebTool:
			<ol>
				...
				<li><a href="page/webtool_sublime.jsp" target="_blank"
					title="前端开发工具技巧介绍——Sublime篇">sublime.jsp </a>
				</li>
				<li><a href="page/webtool_git.jsp" target="_blank"
					title="版本控制入门——搬进Github">git.jsp </a>
				</li>
			</ol>
		</li>
		...
		<li>CSS3:
			<ol>
				<li><a href="page/css3_basic.jsp" target="_blank"
					...
					title="制作3D旋转视频展示区">④videoShow.jsp</a></li>
			</ol></li>
		...
		<li>HTML5:
			<ol>
				<li><a href="page/html5_basic.jsp" target="_blank"
					title="HTML5之元素与标签结构">basic.jsp</a></li>
			</ol></li>
	</ul>
</body>
</html>